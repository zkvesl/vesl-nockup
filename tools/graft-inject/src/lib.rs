...
use crate::codegen::{
    CodegenReport, CodegenStatus, LoadDefaultsReport, emit_effect_union, emit_load_defaults,
    run_codegen_kernel_cause_tags,
};
use crate::lint::{WeldLint, lint_weld_friction, print_weld_lint, run_lint};
...
mod tests {
    use super::*;
    use crate::codegen::emit_kernel_cause_tags_rs;
    use crate::manifest::{Block, GraftBlocks, GraftTypes, load_manifest, sha256_hex};
